...
apt update
apt install -y git unzip apache2 php8.0 curl php8.0-fpm php8.0-curl php8.0-mbstring php8.0-ldap \
php8.0-tidy php8.0-xml php8.0-zip php8.0-gd php8.0-mysql mysql-server-8.0 libapache2-mod-php8.0
